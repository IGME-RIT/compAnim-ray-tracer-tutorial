...
vec3 addLightColorToPixColor(light L, vec3 dirRayToPoint, hitinfo rayHitPoint)
{
	...
	vec3 pointToLight = L.pos - rayHitPoint.point;
	...
	vec3 brightness = L.brightness * L.color * atten;
